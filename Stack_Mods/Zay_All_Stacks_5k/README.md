...
**A Simple Mod that changes the stack size of all itemables to 5.000 units per slot.**
...
1. Download `Zay_All_Stacks_5k.EXMODZ`
2. Import (Zay_All_Stacks_5k.EXMODZ) into your Icarus Mod Manager.

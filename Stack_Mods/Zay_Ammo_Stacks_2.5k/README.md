...
**A Simple Mod that changes the stack size of all ammo items to 2.500 units per slot.**
...
1. Download `Zay_Ammo_Stacks_2.5k.EXMODZ`
2. Import (Zay_Ammo_Stacks_2.5k.EXMODZ) into your Icarus Mod Manager.

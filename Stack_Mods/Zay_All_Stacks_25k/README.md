...
**A Simple Mod that changes the stack size of all itemables to 25.000 units per slot.**
...
1. Download `Zay_All_Stacks_25k.EXMODZ`
2. Import (Zay_All_Stacks_25k.EXMODZ) into your Icarus Mod Manager.

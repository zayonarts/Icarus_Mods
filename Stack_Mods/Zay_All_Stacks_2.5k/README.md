...
**A Simple Mod that changes the stack size of all itemables to 2.500 units per slot.**
...
1. Download `Zay_All_Stacks_2.5k.EXMODZ`
2. Import (Zay_All_Stacks_2.5k.EXMODZ) into your Icarus Mod Manager.
